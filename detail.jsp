        ...
        <div class="row">
            <div class="col-sm-8">
                ...
                <div class="d-flex mb-3">
                    ...
                    <small class="pt-1">(50 Reviews)</small>
                         ...
                         <h3 class="font-weight-semi-bold mb-4 text-danger">${detail.productPrice}$</h3>
            ...
            <div class="col-sm-4">
                <div style="display: flex;                                      
                    ...
                    <h5 style="margin-top: 15px; margin-left: 10px">Uchiha hahaha</h5>
                </div>
                <div class="mt-2">                  
                    <p>Phone number: 0987654321</p>
                    <p>Address: HCM Viet Nam</p>
                </div>
            </div>
        </div>
