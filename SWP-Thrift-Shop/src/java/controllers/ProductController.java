...
public class ProductController extends HttpServlet {
    ...
    private static final String PRODUCT_CRUD = "productCRUD.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Product> listProduct = prd.listAllProduct();
            ...
            if (SETTING.equals(action)) {
                ...
                //setRequest
                Product pro = prd.getProductbyID(productID);
                request.setAttribute("PRODUCT_DETAIL", pro);
            }
        } catch (Exception ex) {
            log("Error at ProductController :" + ex.toString());
        } finally {
