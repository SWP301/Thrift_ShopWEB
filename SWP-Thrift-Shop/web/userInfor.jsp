                    ...
                    <nav aria-label="breadcrumb" class="bg-light rounded-3 p-3 mb-4">
                        <div class="row">
                            ...
                            <div class="col-sm-6 d-flex justify-content-end">
                                ...
                                <a style="text-decoration: none; color: #E50914;" href="${logoutLink}">Log out</a></div>
                        </div>
                    </nav>
                </div>
            </div>
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-6">
                        <div class="card mb-4 mb-md-0">
                            <div class="card-body">
                                <p class="mb-4"><span class="text-primary font-italic me-1">Posted Feed</span>
                                </p>
                    ...
                    <div class="col-md-6">
                        <div class="card mb-4 mb-md-0">
                            <div class="card-body">
                                <p class="mb-4"><span class="text-primary font-italic me-1">Sold Items</span>
                                </p>                               
                                <div class="row ">
                                    <div class="col-sm-9">
                                        <p class="mb-0">Iphone 13</p>
