<%-- 
    ...
    Created on : Nov 2, 2022, 9:39:34 AM
    Author     : htmlo
--%>
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 d-flex justify-content-end">
                        <FORM action="SearchController" method="POST">
                            ...
                            <button style="background-color: #a87e62; border:none" type="submit" name="action" value="adminProductSearch"><i style="background-color: #a87e62;" class="fa-solid fa-magnifying-glass"></i></button>
                        </FORM>
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <c:forEach var="product" items="${listProductAdmin}" varStatus="counter">
                    <form action="ProductController" method="POST">
                        <tr>
                            <td>${counter.count}</td>
                            <td><img class="w-25 h-25" src="<c:url value="img/${product.imageLink}" />" ></td>
                            <td>${product.productName}</td>
                            <td>${product.categoryName}</td>
                            <td>${product.fullName}</td>

                            <td <c:if test="${product.status==false}"> class="text-danger"</c:if>  class="text-success"> ${product.status}</th>
                            <td>
